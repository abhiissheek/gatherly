      ...
      <div className="w-full max-w-md text-center">
        ...
        <div className="flex flex-col items-center gap-4">
          <button
            ...
            className="flex items-center justify-center gap-3 bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 font-medium py-3 px-6 rounded-lg shadow-md transition-all duration-200 w-full max-w-xs"
          >
